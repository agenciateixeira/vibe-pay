      ...
      <header className="fixed top-0 left-0 right-0 z-50">
        ...
        <div className="container mx-auto px-4 py-4 relative z-10">
          <div className="flex items-center justify-between">
            {/* Logo - MAIOR E SEM TEXTO */}
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-22 h-11 sm:w-30 sm:h-20 flex-shrink-0 hover:scale-105 transition-transform">
                <Image 
                  src="/logo.png" 
                  alt="Vibe Pay" 
                  width={80} 
            ...
            <div className="flex flex-col md:flex-row justify-between gap-8 sm:gap-12 mb-8 sm:mb-12">
              ...
              <div className="max-w-sm">
                <div className="flex items-center gap-3 mb-4">
                  <div className="relative w-21 h-16 sm:w-25 sm:h-20 flex-shrink-0">
                    <Image 
                      src="/logo.png" 
                      alt="Vibe Pay" 
                      width={80} 
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li><a href="#" className="text-sm text-vibegray-dark hover:text-vibeyellow transition">Termos de Uso</a></li>
                    <li><a href="#" className="text-sm text-vibegray-dark hover:text-vibeyellow transition">Privacidade</a></li>
                    <li><a href="#" className="text-sm text-vibegray-dark hover:text-vibeyellow transition">Cookies</a></li>
                  </ul>
                </div>
              </div>
            </div>
