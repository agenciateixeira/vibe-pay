-- =====================================================
-- VIBE PAY - ATUALIZAÇÃO DE BANCO EXISTENTE
-- =====================================================
-- Este script adiciona apenas o que está faltando
-- Seguro para executar em banco com dados existentes
-- =====================================================

-- =====================================================
-- 1. ATUALIZAR TABELA users (adicionar colunas faltando)
-- =====================================================

-- Adicionar colunas financeiras se não existirem
...
-- Adicionar constraint de saldo positivo
...
-- =====================================================
-- 5. CRIAR TABELA recurring_charges
-- =====================================================
...
-- =====================================================
-- FIM - BANCO ATUALIZADO COM SUCESSO! ✅
-- =====================================================
-- ✅ Tabela users atualizada com colunas financeiras
-- ✅ 5 novas tabelas criadas (payments, withdrawals, payment_links, recurring_charges, products)
-- ✅ Todos os índices, constraints e triggers configurados
